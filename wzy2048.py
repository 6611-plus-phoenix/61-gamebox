# -*- coding: utf-8 -*-
"""
Created on Fri Dec 11 20:42:45 2020
...
class GameInit(object):
	...
	def drawSurface(cls,screen,matrix,score):
		...
		screen.blit(font2.render('',True,(255,127,0)),(360,20))
		screen.blit(font2.render('',True,(255,127,0)),(300,50))
		a,b = matrix.shape
		for i in range(a):
			for j in range(b):
	...
	def gameOver(matrix,score):
		...
		print(score)
		strnull = []
		if score >= 500 and list_hard[3] ==1 :
			allgameSurface.next_screen(strnull,4)
		if list_hard[3] == 2 and score >= 15000:
			allgameSurface.next_screen(strnull,4)
		if list_hard[3] == 3 and score >= 25000:
			allgameSurface.next_screen(strnull,4)
			# if score>=某个数（建议简单版5000 一般15000 困难25000）
			# print('恭喜过关!')
		else:
			print(score)
			allgameSurface.lose_screen(3)
		return True
	...
	while True:
		for event in pygame.event.get():
			if event.type == pygame.QUIT:
				...
				GameInit.drawSurface(screen,matrix,currentscore)
				if matrix.min() != 0:
					GameInit.gameOver(matrix,currentscore)
		pygame.display.update()
